...
public class ContainerTerminalOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String PHY_POINT_PHY_Y="phy_y";
    public static final String PHY_POINT_PHY_X="phy_x";
    public static final String PHY_POINT="Phy_Point";
  ...
  */
  private ContainerTerminalOntology(){ 
    ...
    ConceptSchema phy_PointSchema = new ConceptSchema(PHY_POINT);
    add(phy_PointSchema, contmas.ontology.Phy_Point.class);
    ...
    phy_PointSchema.add(PHY_POINT_PHY_X, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    phy_PointSchema.add(PHY_POINT_PHY_Y, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    ...
    phy_AgentObjectSchema.add(PHY_AGENTOBJECT_PHY_COLLISIONPOINTS, phy_PointSchema, 0, ObjectSchema.UNLIMITED);
    ...
    phy_PositionSchema.addSuperSchema(phy_PointSchema);
