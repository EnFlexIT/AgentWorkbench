...
public class ContainerTerminalOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String ANNOUNCELOADSTATUS_HAPPEND_AT="happend_at";
    ...
    public static final String ASSIGNBERTH_AVAILABLE_CRANES="available_cranes";
    public static final String ASSIGNBERTH_ASSIGNED_BERTH="assigned_berth";
    public static final String ASSIGNBERTH="AssignBerth";
    public static final String PHY_MOVEMENT_PHY_STEPS="phy_Steps";
    public static final String PHY_MOVEMENT="Phy_Movement";
    public static final String REQUESTENVIRONMENTACTION_AFFECTED_AGENTS="affected_agents";
    public static final String REQUESTENVIRONMENTACTION_ACTION="action";
    public static final String REQUESTENVIRONMENTACTION="RequestEnvironmentAction";
  ...
  */
  private ContainerTerminalOntology(){ 
    ...
    AgentActionSchema requestEnvironmentActionSchema = new AgentActionSchema(REQUESTENVIRONMENTACTION);
    add(requestEnvironmentActionSchema, contmas.ontology.RequestEnvironmentAction.class);
    ...
    AgentActionSchema assignBerthSchema = new AgentActionSchema(ASSIGNBERTH);
    add(assignBerthSchema, contmas.ontology.AssignBerth.class);
    ...
    requestEnvironmentActionSchema.add(REQUESTENVIRONMENTACTION_ACTION, (TermSchema)getSchema(BasicOntology.STRING), ObjectSchema.OPTIONAL);
    requestEnvironmentActionSchema.add(REQUESTENVIRONMENTACTION_AFFECTED_AGENTS, (ConceptSchema)getSchema(BasicOntology.AID), 0, ObjectSchema.UNLIMITED);
    phy_MovementSchema.add(PHY_MOVEMENT_PHY_STEPS, phy_PositionSchema, 0, ObjectSchema.UNLIMITED);
    assignBerthSchema.add(ASSIGNBERTH_ASSIGNED_BERTH, new ConceptSchema("Concept"), ObjectSchema.OPTIONAL);
    assignBerthSchema.add(ASSIGNBERTH_AVAILABLE_CRANES, (ConceptSchema)getSchema(BasicOntology.AID), 0, ObjectSchema.UNLIMITED);
    ...
    announceLoadStatusSchema.add(ANNOUNCELOADSTATUS_HAPPEND_AT, (TermSchema)getSchema(BasicOntology.STRING), ObjectSchema.OPTIONAL);
