...
public class ContainerTerminalOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String NOTHOLDING="NotHolding";
    public static final String HOLDING_AT_ADDRESS="at_address";
  ...
  */
  private ContainerTerminalOntology(){ 
    ...
    ConceptSchema notHoldingSchema = new ConceptSchema(NOTHOLDING);
    add(notHoldingSchema, contmas.ontology.NotHolding.class);
    ...
    ConceptSchema plannedSchema = new ConceptSchema(PLANNED);
    add(plannedSchema, contmas.ontology.Planned.class);
    ...
    holdingSchema.add(HOLDING_AT_ADDRESS, blockAddressSchema, ObjectSchema.OPTIONAL);
    ...
    notHoldingSchema.addSuperSchema(transportOrderChainStateSchema);
    assignedSchema.addSuperSchema(holdingSchema);
    inExecutionSchema.addSuperSchema(notHoldingSchema);
    ...
    pendingForSubCFPSchema.addSuperSchema(notHoldingSchema);
    failedInSchema.addSuperSchema(notHoldingSchema);
    seaSchema.addSuperSchema(domainSchema);
    proposedForSchema.addSuperSchema(notHoldingSchema);
    ...
    plannedSchema.addSuperSchema(transportOrderChainStateSchema);
