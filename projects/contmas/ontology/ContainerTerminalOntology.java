...
public class ContainerTerminalOntology extends jade.content.onto.Ontology  {
  ...
  */
  private ContainerTerminalOntology(){ 
    ...
    failedOutSchema.addSuperSchema(transportOrderChainStateSchema);
    ...
    inExecutionSchema.addSuperSchema(transportOrderChainStateSchema);
    assignedSchema.addSuperSchema(transportOrderChainStateSchema);
