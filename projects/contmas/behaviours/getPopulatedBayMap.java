...
import contmas.ontology.ProvidePopulatedBayMap;
import contmas.ontology.RequestPopulatedBayMap;
...
public class getPopulatedBayMap extends AchieveREInitiator{
	...
	protected Vector<?> prepareRequests(ACLMessage request){
		setParent();
		request.addReceiver(((ContainerAgent) this.myAgent).randomGenerator);
	...
	protected void handleInform(ACLMessage msg){
		...
		parent.getOntologyRepresentation().setContains(((ProvidePopulatedBayMap) content).getProvides());
	}
