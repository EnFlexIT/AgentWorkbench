...
public class GasGridOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String COMPSTATMAXP_AMBIENTTEMPERATURE="ambientTemperature";
    public static final String COMPSTATMAXP_MEASUREMENTSTYPE="measurementsType";
    public static final String COMPSTATMAXP="CompStatMaxP";
    ...
    public static final String COMPSTATCOMPRESSORWITHSPEED_NOMINALSPEED="nominalSpeed";
    public static final String COMPSTATCOMPRESSORWITHSPEED="CompStatCompressorWithSpeed";
  ...
  */
  private GasGridOntology(){ 
    ...
    ConceptSchema compStatCompressorWithSpeedSchema = new ConceptSchema(COMPSTATCOMPRESSORWITHSPEED);
    add(compStatCompressorWithSpeedSchema, gasmas.ontology.CompStatCompressorWithSpeed.class);
    ...
    ConceptSchema compStatMaxPSchema = new ConceptSchema(COMPSTATMAXP);
    add(compStatMaxPSchema, gasmas.ontology.CompStatMaxP.class);
    ...
    electricMotorSchema.add(ELECTRICMOTOR_EMMAXIMALPOWERMEASUREMENTS, compStatMaxPSchema, ObjectSchema.OPTIONAL);
    electricMotorSchema.add(ELECTRICMOTOR_EMSPECIFICENERGYCONSUMPTIONMEASUREMENTS, compStatSECmeasurmentSchema, 0, ObjectSchema.UNLIMITED);
    ...
    compStatStageSchema.add(COMPSTATSTAGE_COMPRESSOR, compStatCompressorWithSpeedSchema, 0, ObjectSchema.UNLIMITED);
    ...
    compStatCompressorWithSpeedSchema.add(COMPSTATCOMPRESSORWITHSPEED_NOMINALSPEED, (TermSchema)getSchema(BasicOntology.INTEGER), ObjectSchema.OPTIONAL);
    ...
    compStatMaxPSchema.add(COMPSTATMAXP_MEASUREMENTSTYPE, compStatMaxPmeasurmentSchema, 0, ObjectSchema.UNLIMITED);
    compStatMaxPSchema.add(COMPSTATMAXP_AMBIENTTEMPERATURE, compStatMaxPtoAmbientTemperatureSchema, 0, ObjectSchema.UNLIMITED);
    ...
    compStatCompressorWithSpeedSchema.addSuperSchema(gridComponentSchema);
