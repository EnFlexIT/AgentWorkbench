...
import de.unidue.stud.sehawagn.contmas.agents.MonitorAgent;
import de.unidue.stud.sehawagn.contmas.behaviours.*;
import de.unidue.stud.sehawagn.contmas.control.Constants;
import de.unidue.stud.sehawagn.contmas.control.Helper;
import de.unidue.stud.sehawagn.contmas.interfaces.DFSubscriber;
import de.unidue.stud.sehawagn.contmas.interfaces.HarbourLayoutRequester;
import de.unidue.stud.sehawagn.contmas.interfaces.Logger;
import de.unidue.stud.sehawagn.contmas.interfaces.OntRepRequester;
import de.unidue.stud.sehawagn.contmas.main.DomainOntologyElement;
import de.unidue.stud.sehawagn.contmas.main.EnvironmentHelper;
import de.unidue.stud.sehawagn.contmas.main.HarbourSetup;
import de.unidue.stud.sehawagn.contmas.measurement.DashboardAgent;
import de.unidue.stud.sehawagn.contmas.ontology.*;
	...
	@Override
		protected void setup(){
			...
			if(ad.getStandaloneMode() == AgentDesktop.AGENTDESKTOP_STANDALONE){
				...
				this.setWorkingDir("projects\\contmasstandalone\\");
			}
			...
			try{
				...
				a=c.createNewAgent("RandomGenerator","de.unidue.stud.sehawagn.contmas.agents.RandomGeneratorAgent",null);
				a.start();
				
				a=c.createNewAgent("HarborMaster","de.unidue.stud.sehawagn.contmas.agents.HarborMasterAgent",args);
				a.start();
				
				this.harbourMaster=new AID();
				this.harbourMaster.setName(a.getName());
	
				a=c.createNewAgent("Optimizer","de.unidue.stud.sehawagn.contmas.agents.BayMapOptimisationAgent",null);
				a.start();
