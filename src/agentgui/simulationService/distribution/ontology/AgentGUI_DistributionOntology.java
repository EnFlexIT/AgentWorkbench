...
public class AgentGUI_DistributionOntology extends jade.content.onto.Ontology  {
  ...
  */
  private AgentGUI_DistributionOntology(){ 
    ...
    add(platformTimeSchema, agentgui.simulationService.distribution.ontology.PlatformTime.class);
    ConceptSchema platformAddressSchema = new ConceptSchema(PLATFORMADDRESS);
    add(platformAddressSchema, agentgui.simulationService.distribution.ontology.PlatformAddress.class);
    ConceptSchema benchmarkResultSchema = new ConceptSchema(BENCHMARKRESULT);
    add(benchmarkResultSchema, agentgui.simulationService.distribution.ontology.BenchmarkResult.class);
    ConceptSchema remoteContainerConfigSchema = new ConceptSchema(REMOTECONTAINERCONFIG);
    add(remoteContainerConfigSchema, agentgui.simulationService.distribution.ontology.RemoteContainerConfig.class);
    ConceptSchema osInfoSchema = new ConceptSchema(OSINFO);
    add(osInfoSchema, agentgui.simulationService.distribution.ontology.OSInfo.class);
    ConceptSchema platformLoadSchema = new ConceptSchema(PLATFORMLOAD);
    add(platformLoadSchema, agentgui.simulationService.distribution.ontology.PlatformLoad.class);
    ConceptSchema platformPerformanceSchema = new ConceptSchema(PLATFORMPERFORMANCE);
    add(platformPerformanceSchema, agentgui.simulationService.distribution.ontology.PlatformPerformance.class);

    // adding AgentAction(s)
    AgentActionSchema showMonitorGUISchema = new AgentActionSchema(SHOWMONITORGUI);
    add(showMonitorGUISchema, agentgui.simulationService.distribution.ontology.ShowMonitorGUI.class);
    AgentActionSchema registerReceiptSchema = new AgentActionSchema(REGISTERRECEIPT);
    add(registerReceiptSchema, agentgui.simulationService.distribution.ontology.RegisterReceipt.class);
    AgentActionSchema clientRemoteContainerRequestSchema = new AgentActionSchema(CLIENTREMOTECONTAINERREQUEST);
    add(clientRemoteContainerRequestSchema, agentgui.simulationService.distribution.ontology.ClientRemoteContainerRequest.class);
    AgentActionSchema clientUnregisterSchema = new AgentActionSchema(CLIENTUNREGISTER);
    add(clientUnregisterSchema, agentgui.simulationService.distribution.ontology.ClientUnregister.class);
    AgentActionSchema clientTriggerSchema = new AgentActionSchema(CLIENTTRIGGER);
    add(clientTriggerSchema, agentgui.simulationService.distribution.ontology.ClientTrigger.class);
    AgentActionSchema clientRegisterSchema = new AgentActionSchema(CLIENTREGISTER);
    add(clientRegisterSchema, agentgui.simulationService.distribution.ontology.ClientRegister.class);
    AgentActionSchema slaveUnregisterSchema = new AgentActionSchema(SLAVEUNREGISTER);
    add(slaveUnregisterSchema, agentgui.simulationService.distribution.ontology.SlaveUnregister.class);
    AgentActionSchema slaveTriggerSchema = new AgentActionSchema(SLAVETRIGGER);
    add(slaveTriggerSchema, agentgui.simulationService.distribution.ontology.SlaveTrigger.class);
    AgentActionSchema slaveRegisterSchema = new AgentActionSchema(SLAVEREGISTER);
    add(slaveRegisterSchema, agentgui.simulationService.distribution.ontology.SlaveRegister.class);
    AgentActionSchema clientRemoteContainerReplySchema = new AgentActionSchema(CLIENTREMOTECONTAINERREPLY);
    add(clientRemoteContainerReplySchema, agentgui.simulationService.distribution.ontology.ClientRemoteContainerReply.class);
