...
public class AgentGUI_BaseOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String XYSERIESCHARTSETTINGS_AUTOSORT="autoSort";
    public static final String XYSERIESCHARTSETTINGS_ALLOWDUPLICATEXVALUES="allowDuplicateXValues";
  ...
  */
  private AgentGUI_BaseOntology(){ 
    ...
    xySeriesChartSettingsSchema.add(XYSERIESCHARTSETTINGS_ALLOWDUPLICATEXVALUES, (TermSchema)getSchema(BasicOntology.BOOLEAN), ObjectSchema.OPTIONAL);
    xySeriesChartSettingsSchema.add(XYSERIESCHARTSETTINGS_AUTOSORT, (TermSchema)getSchema(BasicOntology.BOOLEAN), ObjectSchema.OPTIONAL);
