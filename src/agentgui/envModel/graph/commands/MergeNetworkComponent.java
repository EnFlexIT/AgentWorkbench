 ...
 */
public class MergeNetworkComponent extends AbstractUndoableEdit {
	 ...
	 */
	public MergeNetworkComponent(GraphEnvironmentController graphController, GraphNode graphNode2SplitAt) {
		super();
