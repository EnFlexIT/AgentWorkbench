...
public class NetworkModel implements Cloneable, Serializable {
	...
	copyGraphAndGraphElemnets(netModel);
	...
	HashSet<GraphNode> outerNodes = new HashSet<GraphNode>();
	for (NetworkComponent networkComponent : networkComponents) {
	...
	graphElements.put(newNode.getId(), newNode);
