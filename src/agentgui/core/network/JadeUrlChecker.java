...
public class JadeUrlChecker {
	...
	public JadeUrlChecker(String url) {
		...
		try {
			...
			//err.printStackTrace();
			System.err.println( "[" + Application.getGlobalInfo().getApplicationTitle() + "] Error while try to resolve the address '" + err.getLocalizedMessage() + "'. Please check your Agent.GUI - start options." );
			currURL = null;
		}
