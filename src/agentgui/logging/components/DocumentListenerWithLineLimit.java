 ...
 */
public class DocumentListenerWithLineLimit implements DocumentListener {
	 ...
	 */
	public DocumentListenerWithLineLimit(int maximumLines) {
	 ...
	 */
	public DocumentListenerWithLineLimit(int maximumLines, boolean isRemoveFromStart) {
