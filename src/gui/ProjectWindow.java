...
public class ProjectWindow extends JInternalFrame implements Observer {
	...
	public ProjectWindow( Project CP ) {
		...
		addProjectTab(Language.translate("Umgebungs - Setup"), null, new svganalyzer.SvgAnalyzer2(this.CurrProject), Language.translate("Umgebungs - Setup"));
	...
	public void addProjectTab( String title, Icon icon, Component component, String tip ) {
		// --- GUI-Komponente in das TabbedPane-Objekt einf�gen -------------
		component.setName( title ); 								// --- Component benennen ----
		ProjectViewRightTabs.addTab( title, icon, component, tip);	// --- Component anh�ngen ---
		// --- Neuen Basisknoten einf�gen ------------------
