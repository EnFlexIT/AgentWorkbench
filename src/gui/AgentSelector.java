...
public class AgentSelector extends JDialog implements ActionListener {
	...
	private DefaultListModel jAgentListModel = null;
	...
	private JList getJListAgents() {
		if (jListAgents == null) {
			...
			Vector<Class<?  extends Agent>> AgentList = Application.JadePlatform.AgentsVector;
			jAgentListModel = new DefaultListModel();
