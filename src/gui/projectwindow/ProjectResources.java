...
public class ProjectResources extends JPanel implements ActionListener, Observer {
	...
	private JButton getJButtonAdd() {
		if (jButtonAdd == null) {
			...
			jButtonAdd.setIcon(new ImageIcon(getClass().getResource("/img/ListPlus.png")));
	...
	private JButton getJButtonRemove() {
		if (jButtonRemove == null) {
			...
			jButtonRemove.setIcon(new ImageIcon(getClass().getResource("/img/ListMinus.png")));
	...
	private JButton getJButton() {
		if (jButton == null) {
			...
			jButton.setIcon(new ImageIcon(getClass().getResource("/img/Refresh.png")));
