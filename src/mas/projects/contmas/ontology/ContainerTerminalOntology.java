...
public class ContainerTerminalOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String ACTIVECONTAINERHOLDER_ADMINISTERS="administers";
    ...
    public static final String PASSIVECONTAINERHOLDER_ADMINISTERS="administers";
  ...
  */
  private ContainerTerminalOntology(){ 
    ...
    passiveContainerHolderSchema.add(PASSIVECONTAINERHOLDER_ADMINISTERS, loadListSchema, ObjectSchema.OPTIONAL);
    ...
    activeContainerHolderSchema.add(ACTIVECONTAINERHOLDER_ADMINISTERS, loadListSchema, ObjectSchema.OPTIONAL);
