 ...
 * **************************************************************
 */
package de.enflexit.awb.environment.time;
...
public class TimeModelPresentConfiguration extends TimeModelContinuousConfiguration implements ChangeListener {
    ...
    /* (non-Javadoc)
     * @see de.enflexit.awb.simulation.time.TimeModelContinuousConfiguration#initialize()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see de.enflexit.awb.simulation.time.TimeModelContinuousConfiguration#setTimeModel(de.enflexit.awb.simulation.time.TimeModel)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see de.enflexit.awb.simulation.time.TimeModelContinuousConfiguration#getTimeModel()
     */
    @Override
...
//    /* (non-Javadoc)
//     * @see de.enflexit.awb.simulation.time.TimeModelContinuousConfiguration#getJPanelWidthSettings()
//     */
//    @Override
