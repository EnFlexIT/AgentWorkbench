...
public class TimeModelContinuous extends TimeModelDateBased {
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.time.TimeModel#getJPanel4Configuration(agentgui.core.project.Project, agentgui.core.gui.projectwindow.simsetup.TimeModelController)
	 */
	@Override
