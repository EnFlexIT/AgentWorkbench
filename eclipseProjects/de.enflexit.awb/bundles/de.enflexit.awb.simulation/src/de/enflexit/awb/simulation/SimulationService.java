...
import de.enflexit.awb.simulation.transaction.DiscreteSimulationStepControllerHandler;
...
public class SimulationService extends BaseService {
	...
	public class SimulationServiceImpl implements SimulationServiceHelper {
		...
		// ----------------------------------------------------------
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getSynchTimeDifferenceMillis()
		 */
		public long getSynchTimeDifferenceMillis() throws ServiceException {
			return timeDiff2MainContainer;
		}
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getSynchTimeMillis()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getSynchTimeDate()
		 */
		...
		// ----------------------------------------------------------
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#setAgentMigration(java.util.Vector)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#stopSimulationAgents()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#setPauseSimulation(boolean)
		 */
		...
		// ----------------------------------------------------------
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#setManagerAgent(jade.core.AID)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getManagerAgent()
		 */
		...
		// ----------------------------------------------------------
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#sensorPlugIn(de.enflexit.awb.simulation.sensoring.ServiceSensor)
		 */
		public void sensorPlugIn(ServiceSensor sensor) throws ServiceException {
			getServiceActuator().plugIn(sensor);
		}
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#sensorPlugIn(de.enflexit.awb.simulation.sensoring.ServiceSensor, boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#sensorPlugOut(de.enflexit.awb.simulation.sensoring.ServiceSensor)
		 */
		...
		// ----------------------------------------------------------
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#sensorPlugIn4Manager(de.enflexit.awb.simulation.sensoring.ServiceSensorManager)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#sensorPlugOut4Manager(de.enflexit.awb.simulation.sensoring.ServiceSensorManager)
		 */
		...
		// ----------------------------------------------------------
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getStepSimulationAsynchronous()
		 */
		public boolean getStepSimulationAsynchronous() throws ServiceException {
			return stepSimulationAsynchronous;
		}
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#setStepSimulationAsynchronous(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#stepSimulation(de.enflexit.awb.simulation.environment.EnvironmentModel, int)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#stepSimulation(de.enflexit.awb.simulation.environment.EnvironmentModel, int, boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#notifySensorAgent(jade.core.AID, de.enflexit.awb.simulation.transaction.EnvironmentNotification)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#notifyManagerAgent(de.enflexit.awb.simulation.transaction.EnvironmentNotification)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getEnvironmentModelFromSetup()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getEnvironmentModel()
		 */
		public EnvironmentModel getEnvironmentModel() throws ServiceException {
			return environmentModel;
		}
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#setEnvironmentModel(de.enflexit.awb.simulation.environment.EnvironmentModel)
		 */
		public void setEnvironmentModel(EnvironmentModel envModel) throws ServiceException {
			this.setEnvironmentModel(envModel, false);
		}
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#setEnvironmentModel(de.enflexit.awb.simulation.environment.EnvironmentModel, boolean)
		 */
		...
		// ----------------------------------------------------------
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#setEnvironmentInstanceNextPart(jade.core.AID, java.lang.Object)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getEnvironmentInstanceNextParts()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#getEnvironmentInstanceNextPartsFromMain()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#resetEnvironmentInstanceNextParts()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#displayAgentSetEnvironmentModel(de.enflexit.awb.simulation.environment.EnvironmentModel)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.SimulationServiceHelper#displayAgentNotification(de.enflexit.awb.simulation.transaction.EnvironmentNotification)
		 */
		@Override
	 ...
	 * extending the class 'de.enflexit.awb.simulation.agents.SimulationAgent' and
