...
//			se.printStackTrace();
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.agents.SimulationServiceListener#setEnvironmentModel(de.enflexit.awb.simulation.environment.EnvironmentModel, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.agents.SimulationServiceListener#setNotification(de.enflexit.awb.simulation.transaction.EnvironmentNotification)
	 */
