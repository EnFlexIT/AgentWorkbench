 ...
 */
public class WebAppDatabaseConnectionService implements HibernateDatabaseConnectionService {

	public static final String SESSION_FACTORY_ID = "de.enflexit.awb.ws.core.db";
	
	private static final String cfgFile = 				"/de/enflexit/awb/ws/core/db/cfg/hibernate.cfg.xml";
	private static final String mappingFilesPackage = 	"/de/enflexit/awb/ws/core/db/mappings/";
	private static final String modelClassesPackage = 	"/de/enflexit/awb/ws/core/db/dataModel/";
	...
	private static WebAppDatabaseConnectionService instance;
	public static WebAppDatabaseConnectionService getInstance() {
		if (instance==null) {
			instance = new WebAppDatabaseConnectionService();
		}
		return instance;
	}
	// --- Singleton access for the current instance ------
	 ...
	 */
	public WebAppDatabaseConnectionService() { 
		instance = this;
	}
	...
	public Bundle getLocalBundle() {
		if (localBundle==null) {
			localBundle = FrameworkUtil.getBundle(WebAppDatabaseConnectionService.class);
		}
		return localBundle;
	}
