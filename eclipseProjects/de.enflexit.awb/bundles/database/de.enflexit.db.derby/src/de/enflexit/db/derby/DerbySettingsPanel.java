 ...
 */
public class DerbySettingsPanel extends AbstractDatabaseSettingsPanel {
	...
	public Properties getHibernateConfigurationProperties() {
		...
		props.setProperty(DerbyDatabaseService.HIBERNATE_PROPERTY_DriverClass,  DerbyDatabaseService.getDatabaseDriverClassName()); 
	...
	private String getUrlConfigured() {
		...
		String url = "jdbc:derby://[HostorIP]:[Port]/[Database][additionalParams]";
