 ...
 */
public class MariaDbSQLSettingsPanel extends AbstractDatabaseSettingsPanel {
	 ...
	 */
	public MariaDbSQLSettingsPanel() {
		this.initialize();
	}
	/**
	...
	public void setHibernateConfigurationProperties(Properties properties) {
		...
		if (properties==null) {
			...
			properties = new MariaDbDatabaseService().getHibernateDefaultPropertySettings();
		}
		...
		this.getJTextFieldDatabase().setText(properties.getProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_Catalog));
		this.getJTextFieldUserName().setText(properties.getProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_UserName));
		this.getJTextFieldPassword().setText(properties.getProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_Password));
	...
	public Properties getHibernateConfigurationProperties() {
		...
		props.setProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_DriverClass, Driver.class.getName()); 
		props.setProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_URL, this.getUrlConfigured());
		props.setProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_Catalog, this.getJTextFieldDatabase().getText());
		props.setProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_UserName, this.getJTextFieldUserName().getText());
		props.setProperty(MariaDbDatabaseService.HIBERNATE_PROPERTY_Password, new String(this.getJTextFieldPassword().getPassword()));
		return props;
	}
	...
	private String getUrlConfigured() {
		...
		String url = "jdbc:mariadb://[HostorIP]:[Port]/[Database][additionalParams]";
