 ...
 */
public class PGSettingsPanel extends AbstractDatabaseSettingsPanel {
	...
	public void setHibernateConfigurationProperties(Properties properties) {
		...
		this.getJTextFieldDatabase().setText(properties.getProperty(PGDatabaseService.HIBERNATE_PROPERTY_Catalog));
		this.getJTextFieldUserName().setText(properties.getProperty(PGDatabaseService.HIBERNATE_PROPERTY_UserName));
		this.getJTextFieldPassword().setText(properties.getProperty(PGDatabaseService.HIBERNATE_PROPERTY_Password));
	...
	public Properties getHibernateConfigurationProperties() {
		...
		props.setProperty(PGDatabaseService.HIBERNATE_PROPERTY_DriverClass, Driver.class.getName()); 
		props.setProperty(PGDatabaseService.HIBERNATE_PROPERTY_URL, this.getUrlConfigured());
		props.setProperty(PGDatabaseService.HIBERNATE_PROPERTY_Catalog, this.getJTextFieldDatabase().getText());
		props.setProperty(PGDatabaseService.HIBERNATE_PROPERTY_UserName, this.getJTextFieldUserName().getText());
		props.setProperty(PGDatabaseService.HIBERNATE_PROPERTY_Password, new String(this.getJTextFieldPassword().getPassword()));
		return props;
	}
	...
	private String getUrlConfigured() {
		...
		String url = "jdbc:postgresql://[HostorIP]:[Port]/[Database][additionalParams]";
