 ...
 */
public class TrayIconDialog extends JDialog implements MouseListener {

	private static final long serialVersionUID = -663073173834257611L;
	
	private PopupMenu trayIconPopUp;
	private AwbTrayIcon appTrayIconInstance;
	 ...
	 */
	public TrayIconDialog(Frame owner, AwbTrayIcon trayIconInstance) {
		super(owner);
		this.appTrayIconInstance = trayIconInstance;
		this.trayIconPopUp = trayIconInstance.getTrayPopUp();
		initialize();
	}
