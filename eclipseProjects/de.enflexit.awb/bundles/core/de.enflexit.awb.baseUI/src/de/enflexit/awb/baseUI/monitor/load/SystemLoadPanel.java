...
/**
 * This panel will display all occurring elements of the type {@link ContainerLoadPanel}
 * in this panel with each other. It is used by the {@link LoadMeasureAgent}. 
 *  
 * @see ContainerLoadPanel
...
public class SystemLoadPanel extends JPanel {
	...
	private void initialize() {
		...
		this.setSize(620, ContainerLoadPanel.loadPanelHeight + this.getJToolBarLoad().getHeight());
	...
	public JPanel getJPanelForLoadDisplays() {
		if (jPanelForLoadDisplays == null) {
			...
			jPanelForLoadDisplays.setSize(new Dimension(620, ContainerLoadPanel.loadPanelHeight));
