...
import de.enflexit.awb.simulation.load.LoadInformation;
import de.enflexit.awb.simulation.load.LoadMeasureOSHI;
...
import de.enflexit.awb.simulation.load.threading.ThreadProtocolReceiver;
...
public class LoadService extends BaseService {
	...
	/** The external NAME of the this Service ('de.enflexit.awb.simulation.LoadService'). */
	...
	public class LoadServiceImpl implements LoadServiceHelper {
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#startAgent(java.lang.String, java.lang.String, java.lang.Object[], java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getDefaultRemoteContainerConfig(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#setDefaultRemoteContainerConfig(de.enflexit.awb.simulation.ontology.RemoteContainerConfig)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#startNewRemoteContainer()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#startNewRemoteContainer(de.enflexit.awb.simulation.ontology.RemoteContainerConfig, boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#startNewRemoteContainerStaus(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getLocalCRCReply()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#setAndSaveCRCReplyLocal(de.enflexit.awb.simulation.ontology.ClientRemoteContainerReply)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#putContainerDescription(de.enflexit.awb.simulation.ontology.ClientRemoteContainerReply)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getContainerDescriptions()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getContainerDescription(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getContainerLocations()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getContainerLocation(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#setThresholdLevels(de.enflexit.awb.simulation.load.LoadThresholdLevels)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getContainerLoads()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getContainerLoad(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getContainerQueue()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#setSimulationCycleStartTimeStamp()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getAvgCycleTime()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getAgentMap()
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#setAgentMigration(java.util.Vector)
		 */
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#requestThreadMeasurements(de.enflexit.awb.simulation.agents.LoadMeasureAgent)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#requestAvailableMachines()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#putAvailableMachines()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.LoadServiceHelper#getAvailableMachines()
		 */
		@Override
	...
	private class ServiceComponent implements Service.Slice, ThreadProtocolReceiver {
		...
		private boolean startAgent(String agentName, String agentClassName, Object[] args) {
			...
			try {
				...
				if (agent == null) {
					agent = (Agent) BaseClassLoadServiceUtility.newInstance(agentClassName);
				}
		...
		/* (non-Javadoc)
		 * @see de.enflexit.awb.simulation.load.threading.ThreadProtocolReceiver#receiveThreadProtocol(de.enflexit.awb.simulation.load.threading.ThreadProtocol)
		 */
		@Override
