...
public abstract class TimeModel implements Serializable {
	...
	/**
	 * Has to return the AwbTimeModelConfigurationWidget (an extended JPanel) for the configuration
	 * of a TimeModel (before the agency is executed).
	 *
	 * @return the AwbTimeModelConfigurationWidget for the TimeModel configuration
	 */
	public abstract AwbTimeModelConfigurationWidget getConfigurationWidget();
