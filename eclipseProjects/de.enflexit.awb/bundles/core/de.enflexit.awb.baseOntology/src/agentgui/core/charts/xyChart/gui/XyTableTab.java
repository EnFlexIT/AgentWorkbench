...
public class XyTableTab extends TableTab {
	...
	private JButton getBtnSeriesSettings() {
		if (btnSeriesSettings == null) {
			...
			btnSeriesSettings.setIcon(BundleHelper.getImageIcon("Properties.png"));
	...
	private JButton getBtnPrevSeries() {
		if (btnPrevSeries == null) {
			...
			btnPrevSeries.setIcon(BundleHelper.getImageIcon("ArrowLeft.png"));
	...
	private JButton getBtnNextSeries() {
		if (btnNextSeries == null) {
			...
			btnNextSeries.setIcon(BundleHelper.getImageIcon("ArrowRight.png"));
	...
	private JButton getBtnMoveUp() {
		if (btnMoveUp == null) {
			...
			btnMoveUp.setIcon(BundleHelper.getImageIcon("ArrowUp.png"));
	...
	private JButton getBtnMoveDown() {
		if (btnMoveDown == null) {
			...
			btnMoveDown.setIcon(BundleHelper.getImageIcon("ArrowDown.png"));
