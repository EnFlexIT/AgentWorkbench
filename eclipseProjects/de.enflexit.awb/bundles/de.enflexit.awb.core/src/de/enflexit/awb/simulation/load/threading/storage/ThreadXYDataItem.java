...
/**
 * Represents one (x, y) data item for an {@link ThreadXYSeries}.  Note that
 * subclasses are REQUIRED to support cloning.
 */
public class ThreadXYDataItem implements Cloneable, Comparable<ThreadXYDataItem>, Serializable {
     ...
     */
    public ThreadXYDataItem(Number x, Number y) {
        this.x = x;
        this.y = y;
    }
     ...
     * @param y  the y-value.
     */
    public ThreadXYDataItem(double x, double y) {
     ...
     */
    @Override
    public int compareTo(ThreadXYDataItem other) {
        int result;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ThreadXYDataItem)) {
            return false;
        }
        ThreadXYDataItem that = (ThreadXYDataItem) obj;
