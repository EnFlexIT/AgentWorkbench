 ...
 * **************************************************************
 */
package de.enflexit.awb.simulation.behaviour;
...
public abstract class SimulationServiceBehaviour extends Behaviour implements ServiceSensorInterface {
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.sensoring.ServiceSensorInterface#getAID()
	 */
	public AID getAID() {
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.sensoring.ServiceSensorInterface#doDelete()
	 */
	@Override
	 ...
	 * This method will be executed if a ManagerNotification arrives this agent.
	 *
	 * @param notification the current {@link EnvironmentNotification}
	 * @return the environment notification
	 */
