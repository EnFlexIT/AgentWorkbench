...
public class TimeModelPresent extends TimeModelContinuous {
    ...
    /* (non-Javadoc)
     * @see de.enflexit.awb.simulation.environment.time.TimeModelContinuous#getConfigurationWidget()
     */
    @Override
    public JPanel4TimeModelConfiguration getConfigurationWidget() {
        return new TimeModelPresentConfiguration();
    }
