...
public class LoadServiceProxy extends SliceProxy implements LoadServiceSlice {
	...
	// ----------------------------------------------------------
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#startAgent(java.lang.String, java.lang.String, java.lang.Object[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#startNewRemoteContainer(de.enflexit.awb.simulation.ontology.RemoteContainerConfig, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#setDefaults4RemoteContainerConfig(de.enflexit.awb.simulation.ontology.RemoteContainerConfig)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#getDefaultRemoteContainerConfig(boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#getNewContainer2Wait4Status(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#getLocation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#setThresholdLevels(de.enflexit.awb.simulation.load.LoadThresholdLevels)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#measureLoad()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#getAIDList()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#getAIDListSensorAgents()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#setAgentMigration(java.util.Vector)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#putContainerDescription(de.enflexit.awb.simulation.ontology.ClientRemoteContainerReply)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#getCRCReply()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#requestThreadMeasurement(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#putThreadProtocol(de.enflexit.awb.simulation.load.threading.ThreadProtocol)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.simulation.LoadServiceSlice#mainRequestAvailableMachines()
	 */
	@Override
