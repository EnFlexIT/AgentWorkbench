...
public class PredictiveStaticLoadBalancing extends StaticLoadBalancingBase{
	...
	private static final double LOAD_CPU_CRIT_DANGER  	= (100 * de.enflexit.awb.simulation.load.threading.ThreadCalculateMetrics.FACTOR_MAX_MACHINE_LOAD); //default 95%
