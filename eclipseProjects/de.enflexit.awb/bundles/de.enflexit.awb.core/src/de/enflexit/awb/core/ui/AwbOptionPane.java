...
/**
 * <code>AwbOptionPane</code> makes it easy to pop up a standard dialog box that
 * prompts users for a value or informs them of something.
 * For information about using <code>AwbOptionPane</code>, see
 * <a
 ...
 * <p>
 *
 * While the <code>AwbOptionPane</code>
 * class may appear complex because of the large number of methods, almost
 * all uses of this class are one-line calls to one of the static
 * <code>showXxxDialog</code> methods shown below:
 *
 * <table class="striped">
 * <caption>Common AwbOptionPane method names and their descriptions</caption>
 * <thead>
 *   <tr>
 ...
 * <p>
 * If a <code>AwbOptionPane</code> has configured to all input
 * <code>setWantsInput</code>
 * the bound property <code>AwbOptionPane.INPUT_VALUE_PROPERTY</code>
 ...
 * <dd><code>
 * AwbOptionPane.showMessageDialog(null, "alert", "alert", AwbOptionPane.ERROR_MESSAGE);
 * </code>
 * <dt>Show an internal information dialog with the message, 'information':
 * <dd><pre>
 * AwbOptionPane.showInternalMessageDialog(frame, "information",
 *             "information", AwbOptionPane.INFORMATION_MESSAGE);
 * </pre>
 * <dt>Show an information panel with the options yes/no and message 'choose one':
 * <dd><pre>AwbOptionPane.showConfirmDialog(null,
 *             "choose one", "choose one", AwbOptionPane.YES_NO_OPTION);
 * </pre>
 * <dt>Show an internal information dialog with the options yes/no/cancel and
 * message 'please choose one' and title information:
 * <dd><pre>AwbOptionPane.showInternalConfirmDialog(frame,
 *             "please choose one", "information",
 *             AwbOptionPane.YES_NO_CANCEL_OPTION, AwbOptionPane.INFORMATION_MESSAGE);
 * </pre>
 * <dt>Show a warning dialog with the options OK, CANCEL, title 'Warning', and
 * message 'Click OK to continue':
 * <dd><pre>
 * Object[] options = { "OK", "CANCEL" };
 * AwbOptionPane.showOptionDialog(null, "Click OK to continue", "Warning",
 *             AwbOptionPane.DEFAULT_OPTION, AwbOptionPane.WARNING_MESSAGE,
 *             null, options, options[0]);
 * </pre>
 * <dt>Show a dialog asking the user to type in a String:
 * <dd><code>
 * String inputValue = AwbOptionPane.showInputDialog("Please input a value");
 * </code>
 * <dt>Show a dialog asking the user to select a String:
 * <dd><pre>
 * Object[] possibleValues = { "First", "Second", "Third" };<br>
 * Object selectedValue = AwbOptionPane.showInputDialog(null,
 *             "Choose one", "Input",
 *             AwbOptionPane.INFORMATION_MESSAGE, null,
 *             possibleValues, possibleValues[0]);
 * </pre>
 * </dl>
 * <b>Direct Use:</b><br>
 * To create and use an <code>AwbOptionPane</code> directly, the
 * standard pattern is roughly as follows:
 * <pre>
 *     AwbOptionPane pane = new AwbOptionPane(<i>arguments</i>);
 ...
 *
 */
public abstract class AwbOptionPane {
     ...
     * use the options from the <code>AwbOptionPane</code>.
     */
    ...
    public static String showInputDialog(Object message) {
        return AwbOptionPane.showInputDialog(null, message, null);
    }
    ...
    public static String showInputDialog(Object message, Object initialSelectionValue) {
        return AwbOptionPane.showInputDialog(null, message, initialSelectionValue);
    }
    ...
    public static String showInputDialog(Object parentComponent, Object message, Object initialSelectionValue) {
        return (String)AwbOptionPane.showInputDialog(parentComponent, message, UIManager.getString("OptionPane.inputDialogTitle", Locale.getDefault()), QUESTION_MESSAGE, null, null, initialSelectionValue);
    }
    ...
    public static String showInputDialog(Object parentComponent, Object message, String title, int messageType) {
        return (String)AwbOptionPane.showInputDialog(parentComponent, message, title, messageType, null, null, null);
    }
    ...
    public static void showMessageDialog(Object parentComponent, Object message) {
    	AwbOptionPane.showMessageDialog(parentComponent, message, UIManager.getString("OptionPane.messageDialogTitle", Locale.getDefault()), INFORMATION_MESSAGE);
    }
    ...
    public static void showMessageDialog(Object parentComponent, Object message, String title, int messageType) {
        AwbOptionPane.showMessageDialog(parentComponent, message, title, messageType, null);
    }
    ...
    public static int showConfirmDialog(Object parentComponent, Object message) {
        return AwbOptionPane.showConfirmDialog(parentComponent, message, UIManager.getString("OptionPane.titleText"), YES_NO_CANCEL_OPTION);
    }
    ...
    public static int showConfirmDialog(Object parentComponent, Object message, String title, int optionType) {
        return AwbOptionPane.showConfirmDialog(parentComponent, message, title, optionType, QUESTION_MESSAGE);
    }
    ...
    public static int showConfirmDialog(Object parentComponent, Object message, String title, int optionType, int messageType) {
        return AwbOptionPane.showConfirmDialog(parentComponent, message, title, optionType, messageType, null);
    }
    ...
    public static int showConfirmDialog(Object parentComponent, Object message, String title, int optionType, int messageType, Icon icon) {
        return AwbOptionPane.showOptionDialog(parentComponent, message, title, optionType, messageType, icon, null, null);
    }
