 ...
 * **************************************************************
 */
package de.enflexit.awb.desktop.swt.ui.project;
...
import de.enflexit.awb.desktop.swt.AppModelId;
 ...
 */
public class ProjectEditor extends EditorPart implements AwbProjectWindow {
	...
	public ProjectEditor(MPart mPart, Shell shell) {
		...
		this.setTitleImage(BundleHelper.getInternalSWTImage("AWB-Green16.png"));
	}
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectEditorWindow#getProject()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectEditorWindow#getUserFeedbackForClosingProject(java.lang.String, java.lang.String)
	 */
	@Override
