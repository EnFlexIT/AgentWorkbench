 ...
 */
public class ProjectNewOpen extends JDialog implements AwbProjectInteractionDialog, ActionListener {
	 ...
	 */
	public ProjectNewOpen(Window owner, String title, ProjectAction currentAction ) {
		super(owner, title);
