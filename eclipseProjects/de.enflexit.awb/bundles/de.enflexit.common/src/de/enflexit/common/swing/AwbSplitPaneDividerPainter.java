...
final class AwbSplitPaneDividerPainter extends AbstractRegionPainter {
...
//    private Color color15 = decodeColor("nimbusBlueGrey", 0.0f, -0.050526317f, 0.039215684f, 0);
    ...
    private Color color1 = UIManager.getColor("nimbusBlueGrey");
    private Color color2 = UIManager.getColor("nimbusBlueGrey");
    private Color color3 = UIManager.getColor("nimbusBlueGrey");
    private Color color4 = UIManager.getColor("nimbusFocus");
    private Color color5 = UIManager.getColor("nimbusBlueGrey");
    private Color color6 = UIManager.getColor("nimbusBlueGrey");
    private Color color7 = UIManager.getColor("nimbusBlueGrey");
    private Color color8 = UIManager.getColor("nimbusBlueGrey");
    private Color color9 = UIManager.getColor("nimbusBlueGrey");
    private Color color10 = UIManager.getColor("nimbusBlueGrey");
    private Color color11 = UIManager.getColor("nimbusBlueGrey");
    private Color color12 = UIManager.getColor("nimbusBlueGrey");
    private Color color13 = UIManager.getColor("nimbusBlueGrey");
    private Color color14 = UIManager.getColor("nimbusBlueGrey");
    private Color color15 = UIManager.getColor("nimbusBlueGrey");
    
    
    //Array of current component colors, updated in each paint call
    private Object[] componentColors;

    public AwbSplitPaneDividerPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
