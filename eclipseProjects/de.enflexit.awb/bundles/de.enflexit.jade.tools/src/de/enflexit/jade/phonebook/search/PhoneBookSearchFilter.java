 ...
 */
public interface PhoneBookSearchFilter<GenericPhoneBookEntry extends AbstractPhoneBookEntry> extends Serializable{
	 ...
	 */
	public boolean matches(GenericPhoneBookEntry entry);
}
