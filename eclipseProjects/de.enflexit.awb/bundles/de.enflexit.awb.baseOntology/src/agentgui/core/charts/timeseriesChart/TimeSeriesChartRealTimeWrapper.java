...
public class TimeSeriesChartRealTimeWrapper {
	...
	public void applyLengthRestriction(TimeSeries timeSeries) {
		...
		if (this.getLengthRestriction().getMaxDuration()>0) {
			...
			long oldestTimestampToKeep = lastValuePair.getTimestamp().getLongValue() - this.getLengthRestriction().getMaxDuration();
