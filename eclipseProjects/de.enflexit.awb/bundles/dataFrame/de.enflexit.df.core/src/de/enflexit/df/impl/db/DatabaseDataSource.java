...
public class DatabaseDataSource extends DefaultDataSource {
	...
	// ----------------------------------------------------------------------------------
	/**
	 * Converts the current {@link DatabaseDataSource} into {@link DatabaseSettings}.
	...
	/**
	 * Converts the specified DatabaseSettings into a new instance of a {@link DatabaseDataSource}.
	...
	/**
	 * Places the specified DatabaseSettings into the current {@link DatabaseDataSource}.
