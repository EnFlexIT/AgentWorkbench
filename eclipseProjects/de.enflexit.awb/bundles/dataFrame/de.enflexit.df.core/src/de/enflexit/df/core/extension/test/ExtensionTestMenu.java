...
public class ExtensionTestMenu implements DataWorkbookExtension {
	...
	public String getExtensionDescription() {
		return "This class provides an extension test case for menues";
	}
		...
		if (jButtonHello==null) {
			...
			jButtonHello.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent ae) {
					...
					AwbMessageDialog.showMessageDialog(owner, getExtensionDescription(), "Hello from extension '" + getExtensionName() + "'!", AwbMessageDialog.ERROR_MESSAGE);
				}
			});
		}
		return jButtonHello;
