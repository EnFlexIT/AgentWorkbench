 ...
 */
public class DataWorkbookDatabaseHandler {
	 ...
	 */
	public DataWorkbookDatabaseHandler(Session session) {
	...
	// --------------------------------------------------------------
	// --- From here, working on data with generic methods ----------
	// --------------------------------------------------------------	
	/**
	...
	// --------------------------------------------------------------
	// --- From here, working on actual data ------------------------
	// --------------------------------------------------------------	
	/**
	 * Load data sources.
	 * @return the list
