...
public class AlternativeIDsEditorPanel extends JPanel implements ActionListener{
	...
	private void initialize() {
		...
		gbc_jButtonAdd.insets = new Insets(0, 0, 5, 5);
		...
		gbc_jButtonRemove.insets = new Insets(0, 0, 5, 5);
		...
		gbc_jButtonEdit.insets = new Insets(0, 0, 5, 0);
		...
		gbc_jScrollPaneAlternateIDs.insets = new Insets(0, 0, 0, 5);
