...
import de.enflexit.awb.desktop.dialogs.OntologieSelector;
...
public class OntologyTab extends JPanel implements Observer, ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (actCMD.equals("OntologieAdd")) {
			...
			OntologieSelector onSel = new OntologieSelector((MainWindow)Application.getMainWindow(), currProject.getProjectName() + ": " + ActionTitel, true);			
			...
			if (ontoTree.isSelectionEmpty()) {
				...
				JOptionPane.showMessageDialog( (MainWindow)Application.getMainWindow(), msgText, msgHead, JOptionPane.INFORMATION_MESSAGE);
				return;
			}
