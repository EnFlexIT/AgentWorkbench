...
import de.enflexit.awb.simulation.balancing.PredictiveStaticLoadBalancing;
...
public class Distribution extends JScrollPane implements ActionListener, Observer {
	...
	private boolean isMemorySelectionError(JComboBox<String> combo) {
		...
		if (initMem>=maxiMem) {
			...
			JOptionPane.showMessageDialog((MainWindow)Application.getMainWindow(), msg, head, JOptionPane.ERROR_MESSAGE);
			error = true;
		}
		return error;
	}
