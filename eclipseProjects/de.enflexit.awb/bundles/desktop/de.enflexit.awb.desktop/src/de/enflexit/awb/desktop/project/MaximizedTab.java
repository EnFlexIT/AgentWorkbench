...
public class MaximizedTab extends JInternalFrame {
	...
	private void addComponentListenerOfMainWindow() {
		((MainWindow)(Application.getMainWindow())).addComponentListener(this.getComponentListenerOfMainWindow());
	}
	/**
	 * Removes the component listener of main window.
	 */
	private void removeComponentListenerOfMainWindow() {
		((MainWindow)(Application.getMainWindow())).removeComponentListener(this.getComponentListenerOfMainWindow());
	}
	/**
