...
import de.enflexit.awb.core.project.plugins.PlugInError;
import de.enflexit.awb.core.project.plugins.PlugInListElement;
		...
		if (jButtonRemovePlugIns == null) {
			...
			jButtonRemovePlugIns.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					// --- Remove the PlugIn --------------
					currProject.plugInRemove((PlugIn) pi, true);
					currProject.setUnsaved(true);
				}
			});
