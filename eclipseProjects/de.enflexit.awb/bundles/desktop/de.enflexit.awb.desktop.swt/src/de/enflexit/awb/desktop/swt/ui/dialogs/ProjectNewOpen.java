package de.enflexit.awb.desktop.swt.ui.dialogs;
...
import de.enflexit.awb.desktop.swt.BundleHelper;
import de.enflexit.awb.desktop.swt.SWTResourceManager;
 ...
 */
public class ProjectNewOpen extends Dialog implements AwbProjectInteractionDialog {
    ...
    /* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectNewOpenDialog#setVisible(boolean)
	 */
	@Override
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        if (this.currentAction==ProjectAction.DeleteProject) {
            ...
            this.buttonExportBeforeDelete.setForeground(de.enflexit.awb.desktop.swt.SWTResourceManager.getColor(SWT.COLOR_DARK_RED));
            this.buttonExportBeforeDelete.setFont(de.enflexit.awb.desktop.swt.SWTResourceManager.getFont("Segoe UI", 10, SWT.BOLD));
...
//		buttonCancel.setText(Language.translate("Abbruch"));		
			...
			treeViewerLabelProvider = new ILabelProvider() {
				...
				public Image getImage(Object element) {
					...
					if (elementFile==projectsRootDir) {
						image = BundleHelper.getInternalSWTImage("MBopen.png");
					} else {
						image = BundleHelper.getInternalSWTImage("AWB-Green32.png");
					}
					return image;
				}
			};
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectNewOpenDialog#isCanceled()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectNewOpenDialog#isExportBeforeDelete()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectNewOpenDialog#setProjectName(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectNewOpenDialog#getProjectName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectNewOpenDialog#setProjectFolder(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.enflexit.awb.desktop.swt.gui.AwbProjectNewOpenDialog#getProjectFolder()
	 */
	@Override
