...
public class AgentGUI_DistributionOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String AGENTGUIVERSION_BUILDNO="buildNo";
  ...
  */
  private AgentGUI_DistributionOntology(){ 
    ...
    agentGuiVersionSchema.add(AGENTGUIVERSION_BUILDNO, (TermSchema)getSchema(BasicOntology.INTEGER), ObjectSchema.OPTIONAL);
