...
public class DynTableCellRenderEditor extends AbstractCellEditor implements TableCellRenderer, TableCellEditor {
	...
	private JLabel getFirstColumnDisplay() {
		...
		OntologyVisualisationConfiguration.Colors.setTableCellRendererColors(jLabelDisplay, this.rowTable, this.isSelected);
	...
	private JPanel getSecondColumnDisplayAndEditPanel() {
		...
		OntologyVisualisationConfiguration.Colors.setTableCellRendererColors(this.jPanelToDisplay, this.rowTable, this.isSelected);
