...
public abstract class GraphEdgeShapeConfiguration<T extends Shape> {
	...
	public class QuadCurveConfiguration extends GraphEdgeShapeConfiguration<QuadCurve2D> {
		...
		/* (non-Javadoc)
		 * @see org.awb.env.networkModel.networkModel.GraphEdgeShapeConfiguration#getConfigurationAsString()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.awb.env.networkModel.networkModel.GraphEdgeShapeConfiguration#setConfigurationFromString(java.lang.String)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.awb.env.networkModel.networkModel.GraphEdgeShapeConfiguration#getShape()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.awb.env.networkModel.networkModel.GraphEdgeShapeConfiguration#getCopy()
		 */
		@Override
