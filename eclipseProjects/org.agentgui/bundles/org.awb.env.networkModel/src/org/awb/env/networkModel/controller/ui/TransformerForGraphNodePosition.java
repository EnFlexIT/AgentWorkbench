...
/**
 * The Class TransformerForGraphNodePosition justifies a {@link GraphNode}
 * position in the visualization viewer according to the {@link LayoutSettings},
 * where the position of the used coordinate system is specified by a
 * {@link CoordinateSystemXDirection} and a {@link CoordinateSystemYDirection}.
 *
...
public class TransformerForGraphNodePosition implements Function<GraphNode, Point2D> {
    ...
    /**
     * Instantiates a new transformer for node position that dynamically 'asks' the
     * graph controller about the current and possibly changed settings in the
     * {@link NetworkModel} (dynamic approach).
     * 
    ...
    /**
     * Sets the current instance of the {@link BasicGraphGuiVisViewer} to this
     * static layout.
     * 
    ...
    /**
     * Returns the current {@link BasicGraphGuiVisViewer} that is used to visualize
     * the current Graph.
     * 
    ...
    /**
     * Transforms the specified position into the position for the JUNG
     * visualization.
     *
    ...
    /**
     * Inverse transforms the specified position into the position for the
     * GraphNode.
     *
