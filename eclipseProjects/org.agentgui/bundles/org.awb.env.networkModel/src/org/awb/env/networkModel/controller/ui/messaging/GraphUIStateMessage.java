...
public abstract class GraphUIStateMessage extends GraphUIMessage {
	...
	/* (non-Javadoc)
	 * @see org.awb.env.networkModel.controller.ui.messaging.GraphUIMessage#getMessage()
	 */
	@Override
	public abstract String getMessage();
	
	/* (non-Javadoc)
	 * @see org.awb.env.networkModel.controller.ui.messaging.GraphUIMessage#getMessageType()
	 */
	@Override
