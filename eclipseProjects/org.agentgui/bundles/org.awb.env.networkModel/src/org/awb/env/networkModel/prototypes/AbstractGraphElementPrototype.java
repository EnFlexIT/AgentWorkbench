 ...
 * A AbstractGraphElementPrototype defines how a component in a graph/network environment will be represented
...
public abstract class AbstractGraphElementPrototype {
	...
	/** The id of the element represented by this AbstractGraphElementPrototype */
	protected String id;
	
	/** The type of the element represented by this AbstractGraphElementPrototype */
	protected String type;
	
	/**
	 * This method adds a AbstractGraphElementPrototype to a JUNG graph, with no connection to other graph elements.
