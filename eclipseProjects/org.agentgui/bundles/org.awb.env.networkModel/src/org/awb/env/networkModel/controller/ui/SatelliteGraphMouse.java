...
/**
 * The Class SatelliteGraphMouse is used for the satellite visualization of a
 * graph.
 *
...
public class SatelliteGraphMouse extends ModalSatelliteGraphMouse {
    ...
    /**
     * The Class SatelliteScalingGraphMousePlugin as an individual alternative for
     * the zoom in or zoom out action - especially if maps are displayed and used.
     * 
     * @author Christian Derksen - SOFTEC - ICB - University of Duisburg-Essen
     */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see edu.uci.ics.jung.visualization.control.ScalingGraphMousePlugin#
