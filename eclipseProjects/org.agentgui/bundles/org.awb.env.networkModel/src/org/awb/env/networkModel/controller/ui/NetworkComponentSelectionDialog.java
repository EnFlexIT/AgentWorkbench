...
/**
 * The Class NetworkComponentSelectionDialog allows to select a NetworkComponent
 * in a dialog.
 *
...
public class NetworkComponentSelectionDialog extends JDialog implements ActionListener {
    ...
    /**
     * Instantiates a NetworkComponentSelectionDialog. To directly show the
	...
	if (jPanelNetworkComponentTable == null) {
	    jPanelNetworkComponentTable = new NetworkComponentTablePanel(this.graphController, false,
		    this.enableMultipleSelection, this.columnServicesToAdd);
    ...
    // ----------------------------------------------------------------------------------
    // --- From here, interface methods to the NetworkComponentTablePanel -----
    // Start ---
    // ----------------------------------------------------------------------------------
    /**
