...
/**
 * The Class NeighborhoodSearch enables to search in the specified NetworkModel
 * for specific neighbor components.
 * 
...
public class NeighborhoodSearch {
     ...
     *
     * @param networkModel the network model
     * @param srcNetComp   the source net component
     */
	...
	Vector<NetworkComponent> neighbors = this.networkModel
		.getNeighbourNetworkComponents(this.getSourceNetworkComponent());
    ...
    /**
     * Filters the specified list of NetworkComponents for specified component
     * types.
     *
