...
/**
 * The Class AwbProjectNewOpenDialog is used to create, open or delete a
 * projects.
 * 
...
public class ProjectNewOpen extends Dialog implements AwbProjectNewOpenDialog {
	...
	if (this.projectDirectory != null)
	    this.textProjectDirectory.setText(this.projectDirectory);
	...
	if (this.currentAction == ProjectAction.DeleteProject) {
	    ...
	    this.buttonExportBeforeDelete
		    .setForeground(org.agentgui.gui.swt.SWTResourceManager.getColor(SWT.COLOR_DARK_RED));
	    this.buttonExportBeforeDelete
		    .setFont(org.agentgui.gui.swt.SWTResourceManager.getFont("Segoe UI", 10, SWT.BOLD));
...
//		buttonCancel.setText(Language.translate("Abbruch"));		
	...
	if (this.currentAction == ProjectAction.NewProject) {
		...
		if (projectErrorSource == "ProName") {
		    ...
		    msgText = Language.translate("Bitte geben Sie einen Projektnamen an!" + newLine + newLine
			    + "Zulässig sind beliebige Zeichen " + newLine + "sowie Leerzeichen.");

		} else if (projectErrorSource == "ProFolder") {
		    msgTitle = Language.translate("Fehler - Projektverzeichnis !");
		    msgText = Language.translate("Bitte geben Sie ein korrektes Projektverzeichnis an!" + newLine
			    + newLine + "Zulässig sind beliebige Zeichen (Kleinbuchstaben), die den " + newLine
			    + "Konventionen für Verzeichnisse in Ihrem Betriebssystems" + newLine + "entsprechen. "
			    + newLine + newLine + "Leerzeichen sind nicht zulässig!");

		} else if (projectErrorSource == "ProFolderRegEx") {
		    msgTitle = Language.translate("Fehler - Projektverzeichnis !");
		    msgText = Language.translate("Der gewählte Bezeichner für das Projektverzeichnis enthält" + newLine
		    ...
		    msgTitle = Language.translate("Fehler - Projektverzeichnis !");
		    msgText = Language.translate("Das von Ihnen gewählte Projektverzeichnis wird bereits verwendet!"
			    + newLine + newLine + "Bitte wählen Sie einen anderen Namen für Ihr Verzeichnis");
	    ...
	    // --- Check project file -------------------------------
	    if (projectError == false) {
		String xmlLFileName = Application.getGlobalInfo().getPathProjects() + projectDirectory + File.separator
     ...
     * 
     * @see
     * org.agentgui.gui.AwbProjectNewOpenDialog#setProjectName(java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * org.agentgui.gui.AwbProjectNewOpenDialog#setProjectFolder(java.lang.String)
     */
    @Override
