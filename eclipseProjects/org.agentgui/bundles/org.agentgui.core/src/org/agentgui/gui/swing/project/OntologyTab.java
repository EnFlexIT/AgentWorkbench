...
public class OntologyTab extends JPanel implements Observer, ActionListener {
	...
	if (actCMD.equals("OntologieAdd")) {
	    ...
	    OntologieSelector onSel = new OntologieSelector(Application.getMainWindow(),
		    currProject.getProjectName() + ": " + ActionTitel, true);
	    ...
	    DefaultMutableTreeNode currNode = (DefaultMutableTreeNode) ontoTree.getSelectionPath()
