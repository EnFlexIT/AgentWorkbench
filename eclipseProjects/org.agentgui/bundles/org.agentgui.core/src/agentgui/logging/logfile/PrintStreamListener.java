...
/**
 * The listener interface for receiving printStream events. The class that is
 * interested in processing a printStream event implements this interface, and
 * the object created with that class is registered with a component using the
 * component's <code>addPrintStreamListener</code> method. When the printStream
