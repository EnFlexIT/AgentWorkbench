...
public class AgentGUI_BaseOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String TIMESERIES_REALTIME="realTime";
  ...
  */
  private AgentGUI_BaseOntology(){ 
    ...
    timeSeriesSchema.add(TIMESERIES_REALTIME, (TermSchema)getSchema(BasicOntology.BOOLEAN), ObjectSchema.OPTIONAL);
