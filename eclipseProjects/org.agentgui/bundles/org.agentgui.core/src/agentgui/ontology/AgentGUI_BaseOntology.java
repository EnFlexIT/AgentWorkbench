...
public class AgentGUI_BaseOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String SIMPLE_DOUBLE_STRINGDOUBLEVALUE="StringDoubleValue";
  ...
  */
  private AgentGUI_BaseOntology(){ 
    ...
    // adding Concept(s)
    ConceptSchema simple_DoubleSchema = new ConceptSchema(SIMPLE_DOUBLE);
    add(simple_DoubleSchema, agentgui.ontology.Simple_Double.class);
    ...
    // adding fields
    simple_DoubleSchema.add(SIMPLE_DOUBLE_STRINGDOUBLEVALUE, (TermSchema)getSchema(BasicOntology.STRING), ObjectSchema.OPTIONAL);
