...
public class TimeModelContinuous extends TimeModelDateBased {
     ...
     * In this method the platform time (provided by the SimulationService) will be
     * used to set the timeDiff.
     *
	...
	if (this.accelerationFactor == 1.000) {
	    ...
	    double timeAdditionDouble = this.accelerationFactor * timeInterval;
    ...
    /**
     * Returns the current time depending on the simulation setup. If an agent was
     * set to the instance of the class the synchronized platform time will be used.
     * If no agent is set, the time based on the local system time will be returned
     * 
     ...
     * including the timeDiff. Platform time requires that JADE is running and that
     * the SimulationService is available.
     *
     * @see SimulationServiceHelper#getSynchTimeMillis()
     * 
     * @return the time
     ...
     * SimulationService or, in case of an inactive JADE platform, the time of the
     * local machine.
     *
    ...
    /**
     * Outputs a message to the STDERR console, indicating that no load balancing
     * agent was set and therefore the local time was taken
     */
     ...
     * 
     * @see
     * agentgui.simulationService.time.TimeModel#getJPanel4Configuration(agentgui.
     * core.project.Project,
     * agentgui.core.gui.projectwindow.simsetup.TimeModelController)
     */
    @Override
    public JPanel4TimeModelConfiguration getJPanel4Configuration(Project project,
	    TimeModelController timeModelController) {
     ...
     * 
     * @see
     * agentgui.simulationService.time.TimeModel#setSetupConfiguration(java.util.
     * HashMap)
     */
    @Override
