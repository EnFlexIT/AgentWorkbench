...
/**
 * The Class TimeModelPresentConfiguration is the JPanel used for configuration
 * of the TimeModelPresent.
 */
public class TimeModelPresentConfiguration extends TimeModelContinuousConfiguration implements ChangeListener {
     ...
     * 
     * @param timeModelController thr time model controller
     ...
     * 
     * @see
     * agentgui.simulationService.time.TimeModelContinuousConfiguration#initialize()
     */
    @Override
     ...
     * 
     * @see
     * agentgui.simulationService.time.TimeModelContinuousConfiguration#setTimeModel
     ...
     * 
     * @see
     * agentgui.simulationService.time.TimeModelContinuousConfiguration#getTimeModel
     * ()
     */
    @Override
