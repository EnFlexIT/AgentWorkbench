...
/**
 * The Class TimeFormatSelection can be used as widget in order to configure
 * Strings of time format. Just add this to a appropriate parent container and
 * add an ActionListener to register changes in the widget.
 * 
...
public class TimeFormatSelection extends JPanelForActions {
     ...
     * @param horizontalVerticalGap the horizontal or vertical gap between the
     *                              elements
     * @param font                  the font
     */
	...
	if (horizontalVerticalGap != null)
	    this.horVertGap = horizontalVerticalGap;
	if (font != null)
	    this.setFont(font);
	this.initialize();
    }
