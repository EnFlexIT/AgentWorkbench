...
public abstract class TimeModelBaseExecutionElements implements ActionListener {
    ...
    /**
     * Returns the tool bar title as for example 'Time' or 'Counter'. Place here a
     * name of your choice.
     * 
     ...
     * 
     * @param jToolBar2AddElements the {@link JToolBar} for adding elements
     */
	...
	if (trigger == this.getJButtonTimeConfig()) {
	    this.getJPopupMenuViewConfiguration().show(this.getJButtonTimeConfig(), 0,
		    this.getJButtonTimeConfig().getHeight());
