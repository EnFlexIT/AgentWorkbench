...
public abstract class TimeModel implements Serializable {
    ...
    /**
     * Sets the setup configuration as HashSet&lt;String, String&gt; (property,
     * value) to the TimeModel.
     * 
     ...
     * 
     * @return the setup configuration as HashSet&lt;String, String&gt; consisting
     *         of (property, value)
     */
    public abstract HashMap<String, String> getTimeModelSetting();

    /**
     * Returns the DisplayJPanel4Configuration.java (an extended JPanel) for the
     * configuration of a TimeModel (before the agency is executed).
     *
    ...
    /**
     * Returns a DisplayJToolBar4Execution (an extended JToolBar) that consists of
     * the necessary tools to handle a TimeModel during execution.
     * 
     * @return the DisplayJToolBar4Execution with tools that can be used during the
     *         runtime of the agency
     */
