...
public class LoadInformation {
    ...
    /**
     * Returns the container load hash that holds load information by container
     * name.
     * 
    ...
    /**
     * Returns the container location hash that describes the relation between
     * container name and JADE Location.
     * 
    ...
    /**
     * Returns the {@link LoadAgentMap} that allows to answer: where can I find a
     * specified agent).
     * 
    ...
    /**
     * Resets the Object, which holds the Informations about the agent in relation
     * to it's locations etc.
     * 
     * @see #agentLocations
     */
    ...
    /**
     * This method starts the counting for the agents at the platform and the agents
     * that are located at one specific container
     */
    ...
    /**
     * Returns all known sensor agents (agents that are connected to an environment
     * model by the actuator-sensor relationship of the SimulationService).
     * 
    ...
    /**
     * Returns the Hashtable of new remote containers on which the current platform
     * is waiting for.
     * 
    ...
    /**
     * Method to put the answer of the Server.Master directly in the local public
     * containerDescription - Variable
     *
    ...
    /**
     * Sets the container name on which the running system is waiting for, because a
     * new remote container was requested.
     * 
     ...
     * Main-Container. There are informations about CPU, Memory and operating system
     * available as well as the value from benchmark-test
     */
	...
	/**
	 * Constructor of this Sub-Class, using the ClientRemoteContainerReply from the
	 * {@link ServerMasterAgent}.
	 *
