...
/**
 * Transport Protocol class for recorded Thread-Times Holds information about
 * the measurement of all threads on a machine at a given time.
 * 
...
public class ThreadProtocol implements Serializable {
     ...
     * @param loadCPU       the loaded cpu
     */
    public ThreadProtocol(long timestamp, String processID, String containerName, float loadCPU,
	    Vector<ThreadDetail> threadDetails) {
    ...
    /**
     * Adds the specified ThreadProtocol to the current if the time stamps of the
     * protocols are equal.
     * 
