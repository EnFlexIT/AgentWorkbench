...
public class LoadAgentMap implements Serializable {
    ...
    /**
     * This method counts all of the agents at the platform and the agents, which
     * are located at one specific container.
     */
    ...
    /**
     * Search's for the stored agent information. With this, the current location of
     * the agent can be found for example
     *
