 ...
 * 
 * Displays detailed information about thread/agent load. Builds a Tree view
 * Cluster-&gt;Machines-&gt;JCM-&gt;Container Filter for agents applicable.
 * 
...
public class ThreadMonitorDetailTreeTab extends JPanel implements ActionListener {
	...
	if (splitPane == null) {
	    splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, getLeftPanel(), getRightScrollPane());
	}
	return splitPane;
    }
	...
	if (rightScrollPane == null) {
	    rightScrollPane = new ThreadInfoStorageScrollPane(threadTree.getSeriesChartsDelta(),
		    threadTree.getSeriesChartsTotal(), null, false, "", null);
	}
    ...
    /**
     * The listener interface for receiving myTreeModel events. The class that is
     * interested in processing a myTreeModel event implements this interface, and
     * the object created with that class is registered with a component using the
     * component's <code>addMyTreeModelListener<code> method. When the myTreeModel
