...
/**
 * The class JadeRemoteStartConfiguration serves as data model for the a remote
 * container start in case that the current installation requires the
...
public class JadeRemoteStartConfiguration implements Serializable {
     ...
     * 
     * @return true if remote start configuration is deleted
     */
     ...
     * @return true if configurationFilen is deleted
     */
    ...
    /**
     * Load the file with the jade remote start configuration from the default
     * location.
     *
