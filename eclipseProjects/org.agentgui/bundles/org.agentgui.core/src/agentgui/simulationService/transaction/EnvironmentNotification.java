...
public class EnvironmentNotification implements Serializable {
     ...
     * @param comingFromManager true, if this message comes from the manager of a
     *                          simulation
    ...
    /**
     * Sets the notification to be moved to the last position of the notification
     * queue. In case that this is already the last notification, the notification
     * will be block for a certain amount of time in milliseconds.
     * 
     * @param period the period
     */
