...
public class ClassLoadServiceUtility extends BaseClassLoadServiceUtility {
     ...
     */
    public static Class<? extends Agent> getAgentClass(String agentClassName)
     ...
     *                                   exception
     */
    public static TimeModel getTimeModelInstance(String className)
     ...
     */
    public static PlugIn getPlugInInstance(String pluginClassName, Project project)
     ...
     * @throws InvocationTargetException the invocation target exception
     */
    public static StaticLoadBalancingBase getStaticLoadBalancing(String balancingClassName, Agent executingAgent)
	    throws ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException,
	    InstantiationException, IllegalAccessException, InvocationTargetException {
     ...
     * @throws InvocationTargetException the invocation target exception
     */
    public static DynamicLoadBalancingBase getDynamicLoadBalancing(String balancingClassName, Agent executingAgent)
	    throws ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException,
	    InstantiationException, IllegalAccessException, InvocationTargetException {
