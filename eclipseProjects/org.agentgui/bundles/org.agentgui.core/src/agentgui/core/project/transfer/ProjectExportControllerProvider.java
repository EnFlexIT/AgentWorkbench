...
public class ProjectExportControllerProvider {
    ...
    /**
     * Sets a specialized project export controller class - must be a subclass of
     * {@link DefaultProjectExportController}!
     * 
     * @param projectExportControllerClassName the project export controller class
     *                                         name
     */
    ...
    /**
     * Gets the project export controller. If a specialized subclass is set, an
     * instance of that class will be returned, otherwise an instance of
     * {@link DefaultProjectExportController}
     *
	...
	if (projectExportControllerClassName == null) {
		...
		System.err.println(
			"Error getting the specialized ProjectExportController implementation - using the default one!");
		e.printStackTrace();
		return new DefaultProjectExportController();
	    }
	}
