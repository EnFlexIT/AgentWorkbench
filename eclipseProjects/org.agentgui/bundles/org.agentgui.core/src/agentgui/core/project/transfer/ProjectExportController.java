...
/**
 * This interface can be implemented to provide specialized project export
 * controllers. It is highly recommended not to implement this interface
 * yourself, but extend the provided class
 * {@link DefaultProjectExportController} instead, which provides basic project
 * export functionality and several callback functions to add own code.
 * 
...
public interface ProjectExportController {
    ...
    /**
     * This method can be used to specify additional setup-related files, that
     * should be considered when determining which files to include when exporting
     * projects.
     * 
    ...
    /**
     * This method can be used to provide a list of files and folders that should be
