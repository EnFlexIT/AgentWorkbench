...
public class AgentClassMetricDescription implements Serializable {
     ...
     * @param realMetric          the real load
     ...
     */
    public AgentClassMetricDescription(Project currProject, String className, double userPredictedMetric,
	    double realMetric, double realMetricMin, double realMetricMax, double realMetricAverage) {
	this.currProject = currProject;
     ...
     * 
     * @return {@link Double} the real metric average
     */
