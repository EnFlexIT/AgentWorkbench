...
/**
 * This abstract class is the root for customized plug-in's, which can be loaded
 * to extend an individual agent project.<br>
 * Classes which inherit from this class can be registered to an agent project
 * by using the "Resources"-Tab in the project configuration.
 * 
...
public abstract class PlugIn implements Observer {
    ...
    /**
     * This method be called if the plug-in is loaded into the project. This happens
     * immediately after the project was opened.
     */
    ...
    /**
     * This method will be called if the plug-in will be removed from the project,
     * means immediately before the project will be closed.
     */
    ...
    /**
     * This method will be invoked just after the onPlugOut() method was executed.
     * DO NOT OVERRIDE !!!
     */
    ...
    /**
     * This method can be used in order to add an individual menu at a specified
     * index position of the menu bar.
     *
     * @param myMenu        the my menu
    ...
    /**
     * This method can be used in order to add an individual JMmenuItem to the given
     * menu.
     *
    ...
    /**
     * This method can be used in order to add an individual JMmenuItem at a
     * specified index position of the given menu.
     *
     * @param menu2add            the menu2add
     * @param myMenuItemComponent the my menu item component
     * @param indexPosition       the index position
    ...
    /**
     * This method can be used in order to add an individual menu button to the
     * toolbar.
     *
    ...
    /**
     * This method can be used in order to add an individual menu button a specified
     * index position of the toolbar.
     *
     * @param myComponent   the my component
     * @param indexPosition the index position
     */
    ...
    /**
     * This method can be used in order to add a customized Tab to the project
     * window.
     *
    ...
    /**
     * This method can be used in order to add a customized Tab to the project
     * window at the specified index position. The index position has to be greater
     * than 1, in order to keep the 'Info'-Tab and the 'Configuration'-Tab at its
     * provided position!
     *
     * @param projectWindowTab the project window tab
    ...
    /**
     * Adds a OntologyClassVisualisation to the global settings. The idea of such an
     * object is that you are able to mask / visualize a specified class of your
     * Ontology in order to allow a more common or simplified access to its data.
     * 
     ...
     *
     * @param ontologyClassVisualisation the OntologyClassVisualisation
     */
	...
	if (ontologyClassVisualisation != null) {
	    OntologyClassVisualisation ontoClassVis = OntologyVisualisationConfiguration
		    .registerOntologyClassVisualisation(ontologyClassVisualisation);
    ...
    /**
     * This method can be used to remove all custom components for menus and for the
     * toolbar.
     */
    ...
    /**
     * AgentGUI uses the observer pattern to inform about changes within the
     * project. They can consist on the following kinds of notifications<br>
     * <br>
     ...
     * Here in Detail, while using the 'PlugInNotification.getUpdateReason' -
     * method:<br>
     * =&gt; int PlugIn.ADDED<br>
     * =&gt; int PlugIn.REMOVED<br>
     * Furthermore the instance of the PlugIn can be get by using
     * 'PlugInNotification.getPlugIn()'<br>
     * <br>
     * <br>
	...
	try {
		...
		// System.out.println("Unknown Notification from Observer " +
		// observable.toString() + ": " + updateObject.toString() );
	    }
    ...
    /**
     * In order to perceive individual informations from the {@link Project}
     * {@link Observer} (observer pattern), this method should be used in the
     * extended class. !!! Do NOT override the update method directly !!
     *
     * @param observable   the observable
     * @param updateObject the update object
     */
     ...
     * On project saved.
     *
     * @param isExcludeSetup indicator that reports, if the setup was excluded from
     *                       the save operation
     */
    ...
    /**
     * Overriding his method allows to extend/change the currently used Profile JADE
     * container.
     * 
