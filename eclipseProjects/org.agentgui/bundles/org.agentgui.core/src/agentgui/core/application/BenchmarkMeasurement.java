 ...
 * capability of a computer system to crunch numbers.<br>
 * This will be comparable through a benchmark value in Mflops (Million floating
...
public class BenchmarkMeasurement extends Thread {
     ...
     * If <i>forceBenchmark</i> is set to true the benchmark will be executed
     * regardless of the settings in the property file or if the system was executed
     * in the same network already or not.
     *
     ...
     * computer to crunch numbers.<br>
     * The results will be given in Mflops (Millions of floating point operations
     * per second)
     */
    @Override
    public void run() {
...
//			System.out.println("A V E R A G E: " + Math.round(res[0]) + " Mflops");
    ...
    /**
     * Returns the visual BenchmarkMonitor (if the application is not running
     * headless).
     * 
    ...
    /**
     * Returns the MAC-Address local 'CanonicalHostName' to identify on which
     * computer this measurement were executed.
     * 
    ...
    /**
     * Gets the synchronization object, which can be used to wait until the
     * benchmark thread has properly started
     * 
