 ...
 * application.<br>
 * Since the application does not have direct access to any agents, the
 * UtilityAgent will do some tasks here. <br>
 * Depending on the start-arguments for this Agent the tasks are as follows:<br>
 * <ul>
 * <li>Platform.UTILITY_AGENT_JOB#OpernDF: will send a message in order to show
 * the DF</li>
 ...
 * index[0] = {@link UtilityAgentJob#StartAgent}<br>
 * index[1] = <br>
 ...
 * </li>
 * <li>Platform.UTILITY_AGENT_JOB#ShutdownPlatform: will send a message to the
 * AMS in order to shutdown the whole platform</li>
 * <li>Platform.UTILITY_AGENT_JOB#OpenLoadMonitor: will send a message to show
 * the LoadMonitor</li>
 * <li>Platform.UTILITY_AGENT_JOB#OpenThreadMonitor: will send a message to show
 * the ThreadMonitor</li>
 * </ul>
 * The setup-method of the agent will evaluate the start argument and will add
...
public class UtilityAgent extends Agent {
	...
	OpernDF, StartAgent, ShutdownPlatform, OpenLoadMonitor, OpenThreadMonitor
    }
	...
	case StartAgent:
	    ...
	    this.addBehaviour(
		    new StartAgentBehaviour(waitingInstance, agentName, agentClassName, agentArguments, containerName));
	    break;
