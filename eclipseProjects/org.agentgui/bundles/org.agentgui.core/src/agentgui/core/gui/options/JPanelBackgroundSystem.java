...
/**
 * The Class JPanelBackgroundSystem is used to set the Background System
 * settings.
 * 
...
public class JPanelBackgroundSystem extends AbstractJPanelForOptions {
	...
	this.initialize();
	// --- Translate ----------------------------------
	jLabelServerHeader.setText(Application.getGlobalInfo().getApplicationTitle() + " "
		+ Language.translate("Hintergrundsystem - Konfiguration"));
	jCheckBoxAutoStart
		.setText(" " + Language.translate("Hintergrundsystem beim Programmstart automatisch initialisieren"));
