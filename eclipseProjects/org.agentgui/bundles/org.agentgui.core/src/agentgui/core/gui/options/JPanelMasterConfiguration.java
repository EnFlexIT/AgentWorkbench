...
public class JPanelMasterConfiguration extends AbstractJPanelForOptions {
	...
	// --- Translate ----------------------------------
	jLabelMasterHeader.setText(Application.getGlobalInfo().getApplicationTitle() + " "
		+ Language.translate("Hauptserver (server.master)"));
    }
	...
	if (checkJadeSettings == true) {
		...
		int answer = JOptionPane.showConfirmDialog(this.optionDialog.getContentPane(), msgText, msgHead,
