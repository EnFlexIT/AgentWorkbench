...
public class UpdateOptions extends AbstractOptionTab implements ActionListener {
	...
	private void initialize() {
		...
		gridBagConstraints22.insets = new Insets(5, 20, 5, 5);
		...
		gridBagConstraints11.insets = new Insets(20, 20, 5, 5);
		...
		gridBagConstraints1.insets = new Insets(5, 20, 5, 5);
		...
		gbc_jButtonUpdateSiteApply.anchor = GridBagConstraints.EAST;
		gbc_jButtonUpdateSiteApply.insets = new Insets(20, 0, 5, 20);
